...
class ContactDetails {
    ...
    public boolean equals(Object obj) { // same instance variables used as in equals()! 
        if (obj instanceof ContactDetails) {
            ContactDetails otherContactDetails = (ContactDetails) obj;
            return this.name.equals(otherContactDetails.name) && this.age == otherContactDetails.age;
        } 
        return false;        
    }
    @Override
...
public class ContactTest {
    private static Map<ContactDetails, String> map = new HashMap<>();
    public static void main(String args[]) {
        ContactDetails john  = new ContactDetails("john", 33);
        ContactDetails peter = new ContactDetails("peter",34);
        ...
        ContactDetails mary = new ContactDetails("mary", 21);
    ...
    public static void otherScope(){
        ContactDetails anotherMary = new ContactDetails("mary", 21);// reconstruct "anotherMary"
    ...
    public static void testJane(){
        ...
        ContactDetails jane = new ContactDetails("jane", 21);
